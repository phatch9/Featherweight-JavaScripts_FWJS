...
public interface FeatherweightJavaScriptVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code functionDec}
	 * labeled alternative in {@link FeatherweightJavaScriptParser#expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFunctionDec(FeatherweightJavaScriptParser.FunctionDecContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitString(FeatherweightJavaScriptParser.StringContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitEquality(FeatherweightJavaScriptParser.EqualityContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code assiState}
	 * labeled alternative in {@link FeatherweightJavaScriptParser#expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAssiState(FeatherweightJavaScriptParser.AssiStateContext ctx);
	/**
